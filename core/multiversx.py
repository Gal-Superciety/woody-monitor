...
WOODY_APP_URL = os.getenv("WOODY_APP_URL", "https://woody-website.vercel.app/app").strip()
...
async def woody_app_handler(_: web.Request) -> web.Response:
    logger.info("WOODY APP REDIRECT SERVED")
    return web.HTTPFound(location=WOODY_APP_URL)
